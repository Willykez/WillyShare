...
import willyshare.spark.ui.ActiveTransferKind
import willyshare.spark.ui.FloatingTransferPanel
import willyshare.spark.ui.PulseViewModel
import willyshare.spark.ui.common.SparkPredictiveBackHandler
import willyshare.spark.ui.screens.DashboardScreen
import willyshare.spark.ui.screens.HistoryScreen
...
import willyshare.spark.ui.screens.SplashScreen
import willyshare.spark.ui.screens.TransferringScreen
import willyshare.spark.ui.theme.LocalReducedMotion
import willyshare.spark.ui.theme.MyApplicationTheme
import willyshare.spark.ui.theme.reducedMotionAwareSpec
import willyshare.spark.util.ShareIntentHandler
import willyshare.spark.util.isShareIntent
...
class MainActivity : ComponentActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    enableEdgeToEdge()
    willyshare.spark.util.NotificationHelper.ensureChannels(this)
    ...
    setContent {
      MyApplicationTheme {
        ...
        // Floating progress bubble (Xender-style): sits above every screen except the two
        // full progress screens it's a stand-in for, so leaving Transferring/Receive never
        // loses visibility into an in-flight transfer - the send/receive job itself already
