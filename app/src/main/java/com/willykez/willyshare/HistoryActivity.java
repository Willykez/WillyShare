...
public class HistoryActivity extends AppCompatActivity {
    ...
    private class HistoryAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View convertView, ViewGroup parent) {
            ...
            int statusColor;
            switch (status) {
                case "done":      statusLabel = "✓ done";      statusColor = 0xFF00C853; break;
                case "cancelled": statusLabel = "✗ cancelled"; statusColor = 0xFFEF5350; break;
                case "sending":   statusLabel = "→ sending";   statusColor = 0xFF1A7FFF; break;
                case "receiving": statusLabel = "← receiving"; statusColor = 0xFF1A7FFF; break;
